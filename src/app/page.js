  "use client"; // Wajib agar kita bisa menggunakan useEffect untuk animasi scroll
  ...
  export default function Home() {
    ...
    // Trik untuk mengaktifkan animasi saat elemen masuk ke dalam layar (di-scroll)
    useEffect(() => {
      const observer = new IntersectionObserver(
        (entries) => {
          entries.forEach((entry) => {
            if (entry.isIntersecting) {
              // Menghapus class sembunyi dan menambahkan class muncul
        ...
        { threshold: 0.1 } // Animasi terpicu saat 10% bagian foto sudah terlihat
      );
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div className="flex flex-col gap-6 h-[1200px]">
        <PhotoLinkCard href="/foto-random" imgSrc="/koleksi/IMG-20240505-WA0045.jpg" title="Foto Random" height="h-[280px]" />
      ...
      {/* ================= JALUR TENGAH ================= */}
      <div className="flex flex-col gap-6 h-[1200px]">
        <PhotoLinkCard href="/ngaji-bulanan" imgSrc="/koleksi/IMG_9807.JPG" title="Ngaji Bulanan" height="h-[420px]" />
        ...
        <PhotoSimpleCard imgSrc="/koleksi/IMG-20240508-WA0138.jpg" height="flex-1" />
      </div>

      {/* ================= JALUR KANAN ================= */}
      <div className="flex flex-col gap-6 h-[1200px]">
        <PhotoLinkCard href="/proyek-akhir" imgSrc="/koleksi/Screenshot 2026-08-12 092650.png" title="Proyek Akhir" height="h-[240px]" />
        <PhotoSimpleCard imgSrc="/koleksi/IMG_9496.JPG" height="h-[350px]" />
        <PhotoSimpleCard imgSrc="/koleksi/IMG_7670 (1).JPG" height="flex-1" />
        <PhotoSimpleCard imgSrc="/koleksi/IMG-20240507-WA0123.jpg" height="flex-1" />
      </div>
